...
function setupNavigation() {
  ...
  const handleHashChange = () => {
    ...
    // Незнакомый адрес — на первый экран меню, а не на несуществующий: раньше
    // здесь стоял section-dashboard, которого в разметке нет.
    if (!targetSection) {
      targetSection = document.getElementById('section-whitelist');
    }
