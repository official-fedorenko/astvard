...
namespace AstvardServerMod
{
    ...
    public partial class Plugin : BaseUnityPlugin
    {
        ...
        // Про портал тут когда-то стоял абзац - «сайт с личным кабинетом, мониторингом
        // статуса серверов и заявками на доступ». Снят по просьбе хозяина: страница и так
        // длинная, а человек, читающий её в игре, на сайте уже был - иначе его бы сюда не
        // пустили. Адрес внизу остался, он и есть всё, что от того абзаца было нужно.
        ...
        private void Awake()
        {
            ...
            BindTames(Config);
            BindGarden(Config);
            BindWindowSpots(Config);
            BindServerNames(Config);
            BindPlayerLimit(Config);
